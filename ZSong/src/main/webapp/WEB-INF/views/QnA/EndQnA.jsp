...
<div class="row">
  <div class="col-2">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" href="#" role="tab" aria-controls="home" onclick="waitQnA()">Q&A</a>
      <a class="list-group-item list-group-item-action active" id="list-profile-list" data-toggle="list" href="#" aria-controls="profile" onclick="EndQnA()">지난 Q&A</a>
			                	...
			                	<table style="vertical-align: middle; width: 100%;">
			                		...
			                		<c:if test="${dto.question_Picture.length == null}">
				                		<tr style="width: 100%;">
				                			...
				                			<td width="60%" style="text-align: left; border-right: 1px solid #dee2e6;">
				                				${dto.question_Content}
				                			</td>

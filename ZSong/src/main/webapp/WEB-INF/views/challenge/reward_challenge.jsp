...
<div class="row">
  ...
  <div class="col-10"> 
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="tab-pane fade show active" id="list-reward" role="tabpanel" aria-labelledby="list-reward-list">
      
<table class="table" style="text-align: center;">
  <thead class="table" style="background-color: #007BFF;">
    <tr style="color: white;">
      <th scope="col" style="vertical-align:middle; font-size: 10pt;" width="100px;">챌린지 번호</th>
...
<!-- 						<span class="badge badge-danger">모집중</span> -->
<%-- 					</c:if> --%>
					<c:if test="${dto.challenge_start <= toDay}">
						<span class="badge badge-warning">상금 처리 대기</span>
					</c:if>
